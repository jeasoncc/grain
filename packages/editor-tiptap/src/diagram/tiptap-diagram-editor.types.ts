...
/**
 * Props for TiptapDiagramEditor component
 */
export interface TiptapDiagramEditorProps {
...
/**
 * Ref handle for TiptapDiagramEditor
 */
export interface TiptapDiagramEditorHandle {
...
/**
 * Configuration for TiptapDiagramAdapter
 */
export interface TiptapDiagramAdapterConfig {
