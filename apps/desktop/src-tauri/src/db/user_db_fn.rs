...
pub async fn update_last_login(db: &DatabaseConnection, id: &str) -> Result<UserModel, DbErr> {
    let now = chrono::Utc::now().timestamp_millis();
    update(
        db, id, None, None, None, None, Some(now), None, None, None, None, None, None, None, None, None,
    )
    .await
}
...
pub async fn update_state(
    ...
    update(
        db, id, None, None, None, None, None, None, None, None, None, None, None, None, Some(Some(state)), None,
    )
    .await
}
...
pub async fn update_settings(
    ...
    update(
        db, id, None, None, None, None, None, None, None, None, None, None, None, None, None, Some(Some(settings)),
    )
    .await
}
