 ...
 * 获取所有工作区
 */
export const getWorkspaces = (): TE.TaskEither<AppError, readonly WorkspaceInterface[]> =>
...
export const createWorkspace = (
	...
	pipe(TE.of(encodeCreateWorkspace(input)), TE.chain(api.createWorkspace), TE.map(decodeWorkspace))
