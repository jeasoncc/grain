...
import type { LogLevel, LogConfig, LogEntry } from "@/types/log/log.interface";
...
export interface SimpleLogger {
  ...
  readonly log: (level: LogLevel, message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
  readonly debug: (message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
  readonly info: (message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
  readonly success: (message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
  readonly warn: (message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
  readonly error: (message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
  readonly trace: (message: string, context?: Record<string, unknown>, source?: string) => TE.TaskEither<AppError, void>;
}
...
export const createSimpleLogger = (config: Partial<LogConfig> = {}): SimpleLogger => {
  ...
  const log = (
    ...
    if (logResult.consoleOutput) {
      // eslint-disable-next-line no-console -- This is the core logger implementation that needs console output
...
export const logDebugAsync = (
  ...
  defaultSimpleLogger.debug(message, context, source);
...
export const logInfoAsync = (
  ...
  defaultSimpleLogger.info(message, context, source);
...
export const logSuccessAsync = (
  ...
  defaultSimpleLogger.success(message, context, source);
...
export const logWarnAsync = (
  ...
  defaultSimpleLogger.warn(message, context, source);
...
export const logErrorAsync = (
  ...
  defaultSimpleLogger.error(message, context, source);
...
export const logTraceAsync = (
  ...
  defaultSimpleLogger.trace(message, context, source);
...
export const updateDefaultLoggerConfig = (config: Partial<LogConfig>): {
  ...
  if (validation.isValid) {
    ...
    // eslint-disable-next-line no-console -- This is the core logger implementation
