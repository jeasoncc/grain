...
import type { EditorInstanceState, EditorTab, EditorTabsState } from "@/types/editor-tab"
...
interface EditorTabsStoreActions {
	...
	readonly updateEditorState: (tabId: string, updates: Partial<EditorInstanceState>) => void
 ...
 * 获取指定标签的编辑器状态
 */
export const useEditorState = (tabId: string | null): EditorInstanceState | undefined => {
 ...
 * 获取所有编辑器状态
 */
export const useEditorStates = (): Readonly<Record<string, EditorInstanceState>> => {
