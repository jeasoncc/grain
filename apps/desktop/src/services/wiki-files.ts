...
import { createFileInTree, ensureRootFolder } from "./file-creator";
 ...
 * @returns The created wiki file node
 */
...
export async function getWikiFiles(
  ...
  const allNodes = await NodeRepository.getByWorkspace(workspaceId);
