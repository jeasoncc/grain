...
export const reorderNodes = (
	nodeIds: string[],
): TE.TaskEither<AppError, void> => invokeTE("reorder_nodes", { nodeIds });

/** 批量删除节点 */
export const deleteNodesBatch = (
	nodeIds: string[],
): TE.TaskEither<AppError, void> => invokeTE("delete_nodes_batch", { nodeIds });
...
export const getNodesByWorkspaceAsync = (
	workspaceId: string,
): Promise<NodeResponse[]> => invoke("get_nodes_by_workspace", { workspaceId });
