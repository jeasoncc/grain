      ...
      <div className="space-y-12">
        ...
        {!isTauri && (
          <div className="flex items-start gap-3 p-4 rounded-md bg-muted/50 border border-border/50 text-muted-foreground">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                Custom export paths are only available in the desktop application. 
                Files will be saved to your browser's default download directory.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <div className="space-y-0.5">
              <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Default Export Path</h4>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h4 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-1">Org-mode Integration</h4>
          ...
          {orgSettings.enabled && (
            <div className="space-y-6 pl-4 border-l-2 border-muted ml-1">
              {/* Org-roam Root */}
              <div className="space-y-3">
                <Label className="text-sm font-normal text-muted-foreground">Org-roam Root Directory</Label>
                <div className="flex items-center gap-3">
              ...
              {/* Subdirectory */}
              <div className="space-y-3">
                <Label className="text-sm font-normal text-muted-foreground">Journal Subdirectory</Label>
                <Input
