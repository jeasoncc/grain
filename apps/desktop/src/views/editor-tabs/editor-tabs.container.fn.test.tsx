...
describe("EditorTabsContainer", () => {
	...
	it("should filter tabs by workspaceId", () => {
		const { container } = renderWithTooltip(<EditorTabsContainer workspaceId="workspace-1" />)
	...
	it("should render nothing when no tabs for workspace", () => {
		const { container } = renderWithTooltip(<EditorTabsContainer workspaceId="workspace-3" />)
	...
	it("should handle null workspaceId", () => {
		const { container } = renderWithTooltip(<EditorTabsContainer workspaceId={null} />)
	...
	it("should apply custom className", () => {
		const { container } = renderWithTooltip(
			<EditorTabsContainer workspaceId="workspace-1" className="custom-class" />,
		)
