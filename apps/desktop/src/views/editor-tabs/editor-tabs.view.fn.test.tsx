...
describe("EditorTabsView", () => {
	...
	it("should render nothing when tabs array is empty", () => {
		const { container } = renderWithTooltip(<EditorTabsView {...defaultProps} tabs={[]} />)
		expect(container.firstChild).toBeNull()
	})

	it("should call onSetActiveTab when tab is clicked", () => {
		const onSetActiveTab = vi.fn()
		renderWithTooltip(<EditorTabsView {...defaultProps} onSetActiveTab={onSetActiveTab} />)
	...
	it("should call onCloseTab when close button is clicked", () => {
		...
		renderWithTooltip(<EditorTabsView {...defaultProps} onCloseTab={onCloseTab} />)
	...
	it("should render different icons for different tab types", () => {
		...
		const { container } = renderWithTooltip(<EditorTabsView {...defaultProps} tabs={tabs} />)
