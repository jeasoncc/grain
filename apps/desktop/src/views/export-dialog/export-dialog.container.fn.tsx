...
export const ExportDialogContainer = memo(
	({ open, onOpenChange, workspaceId, workspaceTitle }: ExportDialogContainerProps) => {
		...
		const handleExport = useCallback(async () => {
			...
			try {
				...
				if (format === "markdown") {
					...
					triggerDownload(`${workspaceTitle || "novel"}.md`, md, "text/markdown;charset=utf-8")
		...
		}, [format, workspaceId, workspaceTitle, options, formatLabels, onOpenChange])
