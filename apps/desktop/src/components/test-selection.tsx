  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <div className="p-4 border rounded-lg mb-4" style={{ backgroundColor: 'var(--editor-selection)' }}>
          <strong>当前主题:</strong> {currentTheme?.name}<br />
            ...
            {lightThemes.slice(0, 5).map((theme) => (
              <button
                ...
                className={`w-full text-left p-3 rounded border ${
                  currentTheme?.key === theme.key ? 'border-primary bg-accent' : 'border-border'
                }`}
              >
      ...
      <div className="mt-8">
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            <a href="#" className="text-primary underline">这是链接文字</a>。
