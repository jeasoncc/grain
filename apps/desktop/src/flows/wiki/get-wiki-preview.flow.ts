 ...
 */
export const getWikiPreviewData = (id: string): TE.TaskEither<AppError, WikiPreviewData> =>
	TE.tryCatch(
		async () => {
			...
			const nodeContent =
				E.isRight(contentResult) && contentResult.right ? contentResult.right.content : undefined
