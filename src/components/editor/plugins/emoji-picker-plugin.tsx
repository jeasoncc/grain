...
/**
 * EmojiPickerPlugin using React.lazy instead of next/dynamic
 */
  ...
  const options: Array<EmojiOption> = useMemo(() => {
    return emojiOptions
      .filter((option) => {
        ...
        const matchTitle = new RegExp(queryString, "gi").test(option.title);
        const matchKeywords =
          option.keywords?.some((k) => new RegExp(queryString, "gi").test(k)) ??
          false;
